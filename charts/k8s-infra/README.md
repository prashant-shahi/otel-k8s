...
This lands in whatever namespace your current context points at. To put it
...
Add `-n <namespace>` if you installed the release somewhere other than your
current namespace. See the [Helm docs](https://helm.sh/docs/helm/helm_uninstall/)
for more on the uninstall command.

That removes everything the chart created, including the cluster-scoped
